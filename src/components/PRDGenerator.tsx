        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Fill in the details below and we'll generate a comprehensive Product Requirement Document for you.
            </p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-6 py-4 rounded-lg 
                       text-lg font-semibold transition-colors flex items-center justify-center space-x-2"
            >
              {isGenerating ? (
                <>
